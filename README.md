...
> **📘 AUSUS v1.0 — the Entity Engine.** This repository now contains the
> metadata-first **Entity Engine** vertical slice (RFC-011 / RFC-012): packages
...
> **canonical documentation is [`docs/v1/`](docs/v1/README.md)** (and
> [`RELEASE-NOTES-v1.0.0.md`](RELEASE-NOTES-v1.0.0.md)). The sections below
