...
async function main(): Promise<void> {
  ...
  // ── 2. GET summary ────────────────────────────────────────────────────────
  const summaryUrl = `${API_BASE_URL}/projections/billing.invoice.summary?locale=en-US&renderer=react.web.v1&acceptSchemaVersions=1.2.0`;
  ...
  const detailUrl = `${API_BASE_URL}/projections/billing.invoice.detail?locale=en-US&renderer=react.web.v1&acceptSchemaVersions=1.2.0&subject=${issueRef.identityHandle}`;
  ...
  ok("summary schemaVersion = 1.2.0",             schema1.schemaVersion === "1.2.0");
