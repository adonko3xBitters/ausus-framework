...
return Definition::make('payment', true)
    ...
    ->field('method', FieldType::Enum, ['default' => 'cash', 'typeOptions' => ['values' => ['cash', 'card', 'insurance', 'mobile']]])
    ...
    // guard (actor + the DENY scenario): only a manager may confirm a payment
